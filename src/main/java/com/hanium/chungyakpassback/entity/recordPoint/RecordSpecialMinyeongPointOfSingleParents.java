...
public class RecordSpecialMinyeongPointOfSingleParents extends BaseTime {
    @Id
    ...
    @Builder
    public RecordSpecialMinyeongPointOfSingleParents(User user, com.hanium.chungyakpassback.entity.apt.AptInfo aptInfo, Integer numberOfMinors, Integer ageOfMostYoungChild, Integer bankbookPaymentsCount, Integer periodOfApplicableAreaResidence ,Integer monthOfAverageIncome,Integer total) {
        this.user = user;
