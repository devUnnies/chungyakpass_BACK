...
public class RecordSpecialMinyeongPointOfMultiChild extends BaseTime {
    ...
    @Builder
    public RecordSpecialMinyeongPointOfMultiChild(User user, com.hanium.chungyakpassback.entity.apt.AptInfo aptInfo, MultiChildHouseholdType multiChildHouseholdType, Integer numberOfChild, Integer numberOfChildUnder6Year, Integer bankbookJoinPeriod, Integer periodOfApplicableAreaResidence ,Integer periodOfHomelessness,Integer generationComposition,Integer total) {
        this.user = user;
