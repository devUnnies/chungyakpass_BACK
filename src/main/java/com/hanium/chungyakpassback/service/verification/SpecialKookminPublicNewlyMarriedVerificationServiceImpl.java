...
@Service
public class SpecialKookminPublicNewlyMarriedVerificationServiceImpl implements SpecialKookminPublicNewlyMarriedVerificationService {
    ...
    public SpecialKookminPublicNewlyMarriedResponseDto createSpecialKookminPublicNewlyMarriedVerification(SpecialKookminPublicNewlyMarriedDto specialKookminPublicNewlyMarriedDto) {
        ...
        AptInfoTarget aptInfoTarget = aptInfoTargetRepository.findByHousingTypeAndAptInfo(specialKookminPublicNewlyMarriedDto.getHousingType(), aptInfo).orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND_APT));
