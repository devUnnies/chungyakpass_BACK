...
import com.hanium.chungyakpassback.repository.record.VerificationRecordSpecialMinyeongFirstLifeRepository;
...
@Service
public class SpecialPrivateFirstLifeVerificationServiceImpl implements SpecialPrivateFirstLifeVerificationService {
