...
import com.hanium.chungyakpassback.repository.record.VerificationRecordSpecialMinyeongMultiChildRepository;
...
public class SpecialPrivateMultiChildVerificationServiceImpl implements SpecialPrivateMultiChildVerificationService {
    ...
    public SpecialMinyeongMultiChildResponseDto createSpecialMinyeongMultiChildVerification(SpecialMinyeongMultiChildDto specialMinyeongMultiChildDto) {
        ...
        boolean meetHouseHavingLessThan2Apt = meetHouseHavingLessThan2Apt(user);
