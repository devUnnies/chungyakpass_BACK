...
public class 아파트분양정보_특별공급대상1 {
    ...
    @Builder
    public 아파트분양정보_특별공급대상1(아파트분양정보1 아파트분양정보1,Integer 공고번호, String 주택형, int 공급세대수_다자녀가구, int 공급세대수_신혼부부, int 공급세대수_생애최초, int 공급세대수_노부모부양, int 공급세대수_기관추천, int 공급세대수_이전기관, int 공급세대수_기타) {
