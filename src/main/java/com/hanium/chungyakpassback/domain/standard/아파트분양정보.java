...
public class 아파트분양정보 {
    ...
    @Builder
    public 아파트분양정보(com.hanium.chungyakpassback.domain.enumtype.지역_레벨1 지역_레벨1, com.hanium.chungyakpassback.domain.enumtype.지역_레벨2 지역_레벨2, int 공고번호, String 상세주소, com.hanium.chungyakpassback.domain.enumtype.주택유형 주택유형, 여부 공공주택특별법적용, String 주택명, String 건설업체, LocalDate 모집공고일, LocalDate 당첨자발표일, LocalDate 계약시작일, LocalDate 계약종료일, LocalDate 입주예정월, 여부 투기과열지구, 여부 청약과열지역, 여부 위축지역, 여부 분양가상한제, 여부 정비사업, 여부 공공주택지구, 여부 공공건설임대주택, 여부 대규모택지개발지구) {
        this.지역_레벨1 = 지역_레벨1;
        this.지역_레벨2 = 지역_레벨2;
        this.공고번호 = 공고번호;
        this.상세주소 = 상세주소;
